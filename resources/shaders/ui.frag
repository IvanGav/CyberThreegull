...
void main(){
	...
	vec2 clips[] = {
		vec2(1.3324724435806274, 0.9167219996452332),
		vec2(5.2078046798706055, 3.582930088043213),
		vec2(2.1184375286102295, 1.4574799537658691),
		vec2(2.38411808013916, 1.6406699419021606),
		vec2(2.33441162109375, 1.6056979894638062),
